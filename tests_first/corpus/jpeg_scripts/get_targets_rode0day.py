...
#list_bug_info = []
#for path in paths:
    #bug_line = get_bug_info(path)
    #if bug_line!='':
        #list_bug_info.append(bug_line)
    #else:
        #print("This file doesn't contain Segmentation Fault trace.")
...
#with open(id_targets_file, "w") as outfile:
    #outfile.write("\n".join(all_bugs))

## 1897 è il bug senza informazioni
