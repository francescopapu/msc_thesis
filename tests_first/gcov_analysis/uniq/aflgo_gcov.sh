...
make clean &> /dev/null
./configure CFLAGS="-fprofile-arcs -ftest-coverage -distance=$TMP_DIR/distance.cfg.txt" CC="/home/ubuntu/Desktop/aflgo/afl-clang-fast" LDFLAGS="-fprofile-arcs"  LIBS="-lacl" &> /dev/null
